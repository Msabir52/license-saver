#licensing.ps1
#had taken this to gpt and asked it to refactor all the individual functions to a proper ps module format - 

#no longer being updated-- kept here just in case though
param (
